...
<head>
    ...
    <script src="<%=request.getContextPath()%>/view2/js/subconetent.js"></script>
    ...
    <div id="wrap">
        ...
        <div id="fullbox">
            <div class="contentbox">
               ...
               <button type="button" onclick="location.href='/main/team/income?id=${getNotice[0].title}'">수정</button>
                <div class="writer">
